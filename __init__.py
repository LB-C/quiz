...
def years_match_months_match_days_diff():
    ...
    check50.run("./ages").stdin("4").stdin("Simon").stdin("5").stdin("23").stdin("2005").stdin("Lyra").stdin("5").stdin("12").stdin("2005").stdin("Olivia").stdin("5").stdin("19").stdin("2004").stdin("Audrey").stdin("5").stdin("3").stdin("2005").stdout("Olivia\nAudrey\nLyra\nSimon\n", regex=False)
